...
class ResnetEncoder(nn.Module):
    ...
    def __init__(self, block, decodeblock, num_blocks, num_outputs):
        ...
        self.decode_t_conv2 = nn.ConvTranspose1d(64, 64, kernel_size=16, stride=3, padding = 0, output_padding =0, bias=False)
        ...
        self.decode_t_conv3 = nn.ConvTranspose1d(64,1,kernel_size=15,stride=3,padding=0,output_padding=0, bias=False)
        ...
        self.predictor_fc = nn.Linear(in_features=4736, out_features=2) #4608 9216
...
def NetTrain(wdir,train_log,net_model,train_loader,learning_rate,num_epochs,batch_size,device):
    ...
    for epoch in range(num_epochs):
        for i, (signals, labels) in enumerate(train_loader):
            ...
            #increase the weight of loss1 to make it more important
            loss = 20*loss1 + loss2 + loss3
